...
const renderPokemonAbilities = abilities => {
    ...
    abilities.forEach(ability => {
        ...
        const abilityElementAmount = document.createElement("div");
        abilityElementName.textContent = ability.ability.name;
        abilityElementAmount.textContent = ability.base_ability;
        abilityElement.appendChild(abilityElementName);
        abilityElement.appendChild(abilityElementAmount);
...
const renderNotFound = () => {
    ...
    pokeImg.setAttribute('src', '/Assets/Poke-mist.jpg');
